                            ...
                            {cartItems.map((item) => (
                                <ListGroup.Item key={item._id}>
                                    <Row className="align-items-center">
                                         ...
                                         <Col md={3}>
                                            <Button variant="light" onClick={() => updateCardHandler(item, item.quantity - 1)} disabled={item.quantity === 1}>
                                                <i className="fas fa-minus-circle"></i>
                                            </Button>{' '}
                                            <span>{item.quantity}</span>{' '}
                                            <Button variant="light" onClick={() => updateCardHandler(item, item.quantity + 1)} disabled={item.quantity === item.countInStock}>
